...
public class MemoWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        CharSequence memoName = MemoWidgetConfigureActivity.loadTitlePref(context, appWidgetId);
        CharSequence memoContent = MemoWidgetConfigureActivity.loadContentPref(context,appWidgetId);
        // Construct the RemoteViews object
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.widget_memo);
        views.setTextViewText(R.id.widget_memo_title, memoName);
        views.setTextViewText(R.id.widget_memo_content,memoContent);
